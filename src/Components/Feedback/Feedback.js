...
const Feedback = () => {
    return (
        <div>
            ...
            <h1  className="text-center text-4xl text-blue-600">Feedback </h1>
    ...
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      ...
      <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        <div className="lg:w-1/2 px-6">
          ...
          <p className="mt-1">Izmir,Turkey <br></br>
Texas,United States of America
          </p>
        </div>
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
          <p className="text-red-500 leading-relaxed">gadgetstore56@email.com</p>
    ...
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <p className="leading-relaxed mb-5 text-gray-600">give us your valueable feedback about us.</p>
      ...
      <button className="text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg">Submit</button>
      <p className="text-xs text-gray-500 mt-3">please submit your feedback here</p>
    </div>
  </div>
</section>
