...
const Footer = () => {
  ...
  <div className="container px-6 pt-6">
    ...
    <div className="grid lg:grid-cols-4 md:grid-cols-2">
      <div className="mb-6">
        <h5 className="uppercase font-bold mb-2.5">Downloads</h5>

        <ul className="list-none mb-0">
          <li>
            <a href="#!" className="text-white">Android</a>
          </li>
          <li>
            <a href="#!" className="text-white">IOS</a>
          </li>
          <li>
            <a href="#!" className="text-white">Windows</a>
          </li>
          <li>
            <a href="#!" className="text-white">Mac Os</a>
          </li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Address</a>
          </li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        <h5 className="uppercase font-bold mb-2.5">Help Center</h5>
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Reddit</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div className="text-center p-4" >
    © 2021 Copyright:
    <a className="text-white" href="https://tailwind-elements.com/">Gadget Store</a>
  </div>
</footer>
